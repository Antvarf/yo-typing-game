...
class Event:
    ...
    SERVER_PLAYER_JOINED = 'player_joined'
    SERVER_PLAYER_READY = 'player_ready'
    SERVER_PLAYER_LEFT = 'player_left'
    SERVER_CORRECT_PASSWORD = 'pass_correct'
    SERVER_USERNAME_SWITCH = 'username_switch'
    SERVER_GET_READY = 'get_ready'
    SERVER_GAME_BEGINS = 'game_begins'
    SERVER_NEW_VOTE = 'modes'
    SERVER_GAME_OVER = 'game_over'
    # SERVER_NEW_HOST = 'new_host'
    SERVER_NEW_SESSION = 'new_session'
